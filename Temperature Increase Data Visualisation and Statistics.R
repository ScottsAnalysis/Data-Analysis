...
Temper2<-fread("C:\\SQL LESSONS\\WorldWide Temperatures - DATA ANALYSIS\\World Temp Difference 1970_2021_2.csv")
...
Temper2%>%
  filter(Country=='Denmark' | Country=='United States' | Country=='United Kingdom' | Country=='Indonesia' | Country=='Qatar' | Country=='France')%>%
  ggplot(aes(x=Year, y=TempChange))+
